...
public class JobPostProfileDTO {
    ...
    private CompanyForJobDTO company; // detailed company info
    private UserForJobDTO recruiter; // lightweight recruiter info
    // private Set<JobApplicationDTO> applications; // all applicants
}
